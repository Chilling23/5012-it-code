<template>
  <div class="container">
    <div class="login-page pc-style">
      ...
      <div class="mail-login" type="login">
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="please enter your username" v-model="pageData.loginForm.username" type="text" class="input" />
            <p class="err-view"> </p>
          </div>
          <!---->
        </div>
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="please enter your password" v-model="pageData.loginForm.password" type="password" class="input" />
            <p class="err-view"> </p>
          </div>
      ...
      <div class="operation">
        <a @click="handleCreateUser" class="forget-pwd" style="text-align: left">new account</a>
      </div>
    </div>
  </div>
</template>
...
<script setup lang="ts">
  ...
  const handleLogin = () => {
    userStore
      ...
      .catch((err) => {
        message.warn(err.msg || 'login failure');
      });
  };
