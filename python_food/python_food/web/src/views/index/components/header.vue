<template>
  <div class="main-bar-view">
    ...
    <div class="search-entry">
      ...
      <input placeholder="input key words" ref="keywordRef" @keyup.enter="search" />
    </div>
    <div class="right-view">
      <a href="/admin" target="_blank" type="a-link" style="font-size: 18px; line-height: 32px; width: auto; white-space: nowrap">
        management interface
      </a>
      <!--      <a href="/admin" target="__black" type="a-link" style="line-height: 32px;width:60px;">management interface</a>-->
      <template v-if="userStore.user_token">
        <a-dropdown>
          ...
          <template #overlay>
            <a-menu>
              <a-menu-item>
                <a @click="goUserCenter('orderView')">My orders</a>
              </a-menu-item>
              <a-menu-item>
                <!--                <a @click="goUserCenter('userInfoEditView')"></a>-->
              </a-menu-item>
              <a-menu-item>
                <a @click="quit()">Quit</a>
              </a-menu-item>
      ...
      <div>
        <a-drawer title="My messages" placement="right" :closable="true" :maskClosable="true" :visible="msgVisible" @close="onClose">
