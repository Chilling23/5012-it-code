    ...
    <div class="tel-regist-page pc-style">
      ...
      <div class="regist-padding">
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="enter your username" v-model="tData.loginForm.username" type="text" class="input" />
            <p class="err-view"> </p>
          </div>
        </div>
      </div>
      <div class="regist-padding">
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="enter your password" v-model="tData.loginForm.password" type="password" class="input" />
            <p class="err-view"> </p>
          </div>
        </div>
      </div>
      <div class="regist-padding">
        <div class="common-input">
          <img :src="PwdIcon" class="left-icon" />
          <div class="input-view">
            <input placeholder="enter your password again" v-model="tData.loginForm.repassword" type="password" class="input" />
            <p class="err-view"> </p>
          </div>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  const handleRegister = () => {
    ...
    userRegisterApi({
      ...
      .catch((err) => {
        message.error(err.msg || 'register fail');
      });
  };
</script>
